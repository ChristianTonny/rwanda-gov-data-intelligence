...
export function SearchBar({ value, onChange, onSubmit, placeholder }: { value: string; onChange: (v: string) => void; onSubmit?: () => void; placeholder?: string }) {
  return (
    <div className="relative w-full">
      ...
      <input
        className="w-full h-10 pl-10 pr-4 rounded-lg border border-gray-200 outline-none focus:border-brand focus:ring-2 focus:ring-brand transition-colors duration-200"
